...
public class Map8 {
    public Map8(HashMap<Integer, List<String>> table_map, HashMap<Integer, String> select_chip, HashMap<Integer, Integer> point){
        ...
        table_map.put(7, Arrays.asList("16",  "+",  "4",  "-",  "2",  "2",  "=", "17",  "+",  "1",  "-", "20",  "=",  "-",  "2"));
