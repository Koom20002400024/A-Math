...
public class Map5 {
    public Map5(HashMap<Integer, List<String>> table_map, HashMap<Integer, String> select_chip){
        ...
        table_map.put(7, Arrays.asList(null, null, null, null, null, null, null, "2", "=", "2", null, null, null, null, null));
