...
public class Map6 {
    public Map6(HashMap<Integer, List<String>> table_map, HashMap<Integer, String> select_chip, HashMap<Integer, Integer> point){
        ...
        table_map.put(6, Arrays.asList(null, null, null, null, null, null, null, null, null, null, "1",  null, "17", null, null));
        table_map.put(7, Arrays.asList(null, null, null, null,  "2",  "0",  "=", "19",  "+",  "1", "=",  "20",  "=",  "2", "0"));
        table_map.put(8, Arrays.asList(null, null, null, null, null, null, null, null, null, null, "1",  null,  "1", null, null));
        table_map.put(9, Arrays.asList(null, null, null, null, null, null, null, null, null, null, null, null,  "7", null, null));
